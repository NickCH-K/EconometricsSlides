...
- Both will report "stars" - if the p-value is below a certain $alpha$, you get stars! Be careful - the defaults are different in `feols()` by itself (`r '*'`) = .05) and `etable()` (`r '**'` = .05)
