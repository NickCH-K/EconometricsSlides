...
- Both will report "stars" - if the p-value is below a certain $alpha$, you get stars! Be careful - the defaults are different in `feols()` (one star means $p \leq .05$) than is standard in economics papers (two stars means $p \leq .05$)
