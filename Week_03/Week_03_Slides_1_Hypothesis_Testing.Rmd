...
- English letters like $X$ are *actual data from our sample*
...
- This of course comes because data varies from saple to sample, and $Data \rightarrow Calculation \rightarrow Estimate$.
...
- Why not just pick a super lower confidence level so we don't have false positives?
