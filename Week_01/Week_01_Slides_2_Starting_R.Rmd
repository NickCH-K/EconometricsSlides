...
- **If you installed R and/or RStudio a while ago, please reinstall it. I'd like everyone to have 4.5 or newer and the newest version of RStudio.**

---

# Learning to Code

Do we really have to learn this? Can't AI write our code for us?

- Yes
- Code is only good if it is right. Data analysis code in particular will often "work" but be wrong
- If you don't know how to code, you won't be able to tell if the AI code is right

---

# Learning to Code

- Yes, you can use AI to help write your code
- I have Copilot enabled in my RStudio and you can too!
- Using AI to check your code and interpret error messages for you is great!
- But it's all fruitless unless you know enough code that you *could* have done it yourself
