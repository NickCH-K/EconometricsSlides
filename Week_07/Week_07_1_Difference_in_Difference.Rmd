...
- Some approaches to DID help ease the parallel trends assumption by "controlling for trend" - adjusting for the post-treatment jumps the treatment and control groups would have been expected to have based on their trends before treatment. When would this work? When would this not work?
