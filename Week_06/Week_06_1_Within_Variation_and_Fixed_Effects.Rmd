...
- In my opinion `feols` is the clear winner. Plus, **fixest** does all sorts of other neat stuff like fixed effects in nonlinear models like logit, regression tables, joint-test functions, and on and on
